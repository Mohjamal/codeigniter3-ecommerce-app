...
<head>
    ...
    <!-- <link rel="shortcut icon" type="image/x-icon" href="assets/shop/img/logo/favicon.png"> -->

    <!-- CSS here -->
    <link rel="stylesheet" href="assets/shop/css/bootstrap.css">
    <link rel="stylesheet" href="assets/shop/css/animate.css">
    <link rel="stylesheet" href="assets/shop/css/swiper-bundle.css">
    <link rel="stylesheet" href="assets/shop/css/slick.css">
    <link rel="stylesheet" href="assets/shop/css/magnific-popup.css">
    <link rel="stylesheet" href="assets/shop/css/font-awesome-pro.css">
    <link rel="stylesheet" href="assets/shop/css/flaticon_shofy.css">
    <link rel="stylesheet" href="assets/shop/css/spacing.css">
...
<body>
            ...
            <div id="loading-center-absolute">
                ...
                <div class="tp-preloader-content">
                    <div class="tp-preloader-logo">
                        ...
                        <!-- <img src="assets/shop/img/logo/preloader/preloader-icon.svg" alt=""> -->
                    </div>
            ...
            <div class="offcanvas__content">
                <div class="offcanvas__top mb-70 d-flex justify-content-between align-items-center">
                    <div class="offcanvas__logo logo">
                        <a href="index.html">
                            <!-- <img src="assets/shop/img/logo/logo.svg" alt="logo"> -->
                        </a>
                    </div>
                </div>
                ...
                <div class="offcanvas__contact align-items-center d-none">
                    <div class="offcanvas__contact-icon mr-20">
                        <span>
                            <img src="assets/shop/img/icon/contact.png" alt="">
                        </span>
                    </div>
                    ...
                    <div class="offcanvas__select language">
                        <div class="offcanvas__lang d-flex align-items-center justify-content-md-end">
                            <div class="offcanvas__lang-img mr-15">
                                <img src="assets/shop/img/icon/language-flag.png" alt="">
                            </div>
        ...
        <div class="cartmini__wrapper d-flex justify-content-between flex-column">
            <div class="cartmini__top-wrapper">
                    ...
                    <div class="cartmini__widget-item">
                        <div class="cartmini__thumb">
                            <a href="product-details.html">
                                <img src="assets/shop/img/product/product-1.jpg" alt="">
                            </a>
                        </div>
                ...
                <div class="cartmini__empty text-center d-none">
                    <img src="assets/shop/img/product/cartmini/empty-cart.png" alt="">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-2 col-lg-6 col-md-6 col-sm-5 col-8">
                            <div class="tp-header-left-5 d-flex align-items-center">
                                ...
                                <div class="logo">
                                    <a href="index.html">
                                        <!-- <img src="assets/shop/img/logo/logo-white.svg" alt="logo"> -->
                                    </a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row row-cols-1 row-cols-lg-3 row-cols-xl-3">
                                            ...
                                            <div class="home-menu-item ">
                                                <a href="index.html">
                                                    <div class="home-menu-thumb p-relative fix">
                                                        <img src="assets/shop/img/menu/menu-home-1.jpg" alt="">
                                                    </div>
                                        ...
                                        <div class="col">
                                            <div class="home-menu-item ">
                                                <a href="index-2.html">
                                                    <div class="home-menu-thumb p-relative fix">
                                                        <img src="assets/shop/img/menu/menu-home-2.jpg" alt="">
                                                    </div>
                                                    <div class="home-menu-content">
                                        ...
                                        <div class="col">
                                            <div class="home-menu-item ">
                                                <a href="index-3.html">
                                                    <div class="home-menu-thumb p-relative fix">
                                                        <img src="assets/shop/img/menu/menu-home-3.jpg" alt="">
                                                    </div>
                                                    <div class="home-menu-content">
                                        ...
                                        <div class="col">
                                            <div class="home-menu-item ">
                                                <a href="index-4.html">
                                                    <div class="home-menu-thumb p-relative fix">
                                                        <img src="assets/shop/img/menu/menu-home-4.jpg" alt="">
                                                    </div>
                                                    <div class="home-menu-content">
                                        ...
                                        <div class="col">
                                            <div class="home-menu-item ">
                                                <a href="index-5.html">
                                                    <div class="home-menu-thumb p-relative fix">
                                                        <img src="assets/shop/img/menu/menu-home-5.jpg" alt="">
                                                    </div>
                                                    <div class="home-menu-content">
                                ...
                                <div class="mega-menu-left">
                                    <div class="mega-menu-list">
                                        <ul>
                                            <li>
                                                <div class="mega-menu-img">
                                                    <img src="assets/shop/img/header/menu/grocery/img-1.png" alt="">
                                                </div>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="mega-menu-img">
                                                    <img src="assets/shop/img/header/menu/grocery/img-2.png" alt="">
                                                </div>
                                                <a href="shop.html" class="mega-menu-title">Fresh Fruits</a>
                                                <ul>
                                    ...
                                    <div class="mega-menu-brand">
                                        <a href="#">
                                            <img src="assets/shop/img/header/menu/grocery/menu-brand-1.png" alt="">
                                        </a>
                                        <a href="#">
                                            <img src="assets/shop/img/header/menu/grocery/menu-brand-2.png" alt="">
                                        </a>
                                        <a href="#">
                                            <img src="assets/shop/img/header/menu/grocery/menu-brand-3.png" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="mega-menu-right" data-bg-color="#F9F9F9">
                                    ...
                                    <div class="menu-shop-item d-flex align-items-center">
                                        <div class="menu-shop-thumb">
                                            <a href="product-details.html">
                                                <img src="assets/shop/img/header/menu/grocery/img-3.png" alt="">
                                            </a>
                                        </div>
                                    ...
                                    <div class="menu-shop-item d-flex align-items-center">
                                        <div class="menu-shop-thumb">
                                            <a href="product-details.html">
                                                <img src="assets/shop/img/header/menu/grocery/img-4.png" alt="">
                                            </a>
                                        </div>
                                        <div class="menu-shop-content">
                                            <div class="menu-shop-meta">
                                    ...
                                    <div class="menu-shop-item d-flex align-items-center">
                                        <div class="menu-shop-thumb">
                                            <a href="product-details.html">
                                                <img src="assets/shop/img/header/menu/grocery/img-5.png" alt="">
                                            </a>
                                        </div>
                                        <div class="menu-shop-content">
                                            <div class="menu-shop-meta">
                                    ...
                                    <div class="menu-shop-item d-flex align-items-center">
                                        <div class="menu-shop-thumb">
                                            <a href="product-details.html">
                                                <img src="assets/shop/img/header/menu/grocery/img-6.png" alt="">
                                            </a>
                                        </div>
                                        <div class="menu-shop-content">
                                            <div class="menu-shop-meta">
    ...
    <main>
                    ...
                    <div class="tp-slider-item-5 scene tp-slider-height-5 swiper-slide d-flex align-items-center" data-bg-color="#F3F3F3">
                        <div class="tp-slider-shape-5 ">
                            <div class="tp-slider-shape-5-1">
                                <img class="layer" data-depth=".2" src="assets/shop/img/slider/5/shape/shape-1.png" alt="">
                            </div>
                            <div class="tp-slider-shape-5-2">
                                <img class="layer" data-depth=".2" src="assets/shop/img/slider/5/shape/shape-2.png" alt="">
                            </div>
                            <div class="tp-slider-shape-5-3">
                                <img class="layer" data-depth=".2" src="assets/shop/img/slider/5/shape/shape-3.png" alt="">
                            </div>
                            <div class="tp-slider-shape-5-4">
                                <img class="layer" data-depth=".2" src="assets/shop/img/slider/5/shape/shape-4.png" alt="">
                            </div>
                        </div>
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-xxl-7 col-xl-7 col-lg-6">
                                    <div class="tp-slider-content-5 p-relative z-index-1">
                                        <div class="tp-slider-subtitle-img">
                                            <img src="assets/shop/img/slider/5/subtitle.png" alt="">
                                        </div>
                                ...
                                <div class="col-xxl-5 col-xl-5 col-lg-6">
                                    <div class="tp-slider-thumb-wrapper-5 p-relative">
                                        <div class="tp-slider-thumb-shape-5 one d-none d-sm-block">
                                            <img data-depth="0.1" class="layer offer" src="assets/shop/img/slider/5/shape/offer.png" alt="">
                                        </div>
                                        <div class="tp-slider-thumb-5 main-img">
                                            <img data-depth="0.2" class="layer" src="assets/shop/img/slider/5/slider-1.png" alt="">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="tp-category-item-5 p-relative z-index-1 fix swiper-slide" data-bg-color="#E5EFE2">
                                        <a href="shop-category.html">
                                            <div class="tp-category-thumb-5 include-bg" data-background="assets/shop/img/category/5/category-1.jpg"></div>
                                    ...
                                    <div class="tp-category-item-5 p-relative z-index-1 fix swiper-slide" data-bg-color="#F5EFEC">
                                        <a href="shop-category.html">
                                            <div class="tp-category-thumb-5 include-bg" data-background="assets/shop/img/category/5/category-2.jpg"></div>
                                            <div class="tp-category-content-5">
                                    ...
                                    <div class="tp-category-item-5 p-relative z-index-1 fix swiper-slide" data-bg-color="#F2E0E3">
                                        <a href="shop-category.html">
                                            <div class="tp-category-thumb-5 include-bg" data-background="assets/shop/img/category/5/category-3.jpg"></div>
                                            <div class="tp-category-content-5">
                                    ...
                                    <div class="tp-category-item-5 p-relative z-index-1 fix swiper-slide" data-bg-color="#E6F1E0">
                                        <a href="shop-category.html">
                                            <div class="tp-category-thumb-5 include-bg" data-background="assets/shop/img/category/5/category-4.jpg"></div>
                                            <div class="tp-category-content-5">
                                    ...
                                    <div class="tp-category-item-5 p-relative z-index-1 fix swiper-slide" data-bg-color="#F2E3D5">
                                        <a href="shop-category.html">
                                            <div class="tp-category-thumb-5 include-bg" data-background="assets/shop/img/category/5/category-5.jpg"></div>
                                            <div class="tp-category-content-5">
                                    ...
                                    <div class="tp-category-item-5 p-relative z-index-1 fix swiper-slide" data-bg-color="#F6E9E8">
                                        <a href="shop-category.html">
                                            <div class="tp-category-thumb-5 include-bg" data-background="assets/shop/img/category/5/category-6.jpg"></div>
                                            <div class="tp-category-content-5">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="tp-product-item-5 p-relative white-bg mb-40">
                                            <div class="tp-product-thumb-5 w-img fix mb-15">
                                                <a href="product-details.html">
                                                    <img src="assets/shop/img/product/5/product-1.jpg" alt="">
                                                </a>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="tp-product-item-5 p-relative white-bg mb-40">
                                            <div class="tp-product-thumb-5 w-img fix mb-15">
                                                <a href="product-details.html">
                                                    <img src="assets/shop/img/product/5/product-2.jpg" alt="">
                                                </a>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="tp-product-item-5 p-relative white-bg mb-40">
                                            <div class="tp-product-thumb-5 w-img fix mb-15">
                                                <a href="product-details.html">
                                                    <img src="assets/shop/img/product/5/product-3.jpg" alt="">
                                                </a>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="tp-product-item-5 p-relative white-bg mb-40">
                                            <div class="tp-product-thumb-5 w-img fix mb-15">
                                                <a href="product-details.html">
                                                    <img src="assets/shop/img/product/5/product-4.jpg" alt="">
                                                </a>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="tp-product-item-5 p-relative white-bg mb-40">
                                            <div class="tp-product-thumb-5 w-img fix mb-15">
                                                <a href="product-details.html">
                                                    <img src="assets/shop/img/product/5/product-5.jpg" alt="">
                                                </a>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="tp-product-item-5 p-relative white-bg mb-40">
                                            <div class="tp-product-thumb-5 w-img fix mb-15">
                                                <a href="product-details.html">
                                                    <img src="assets/shop/img/product/5/product-6.jpg" alt="">
                                                </a>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="tp-product-item-5 p-relative white-bg mb-40">
                                            <div class="tp-product-thumb-5 w-img fix mb-15">
                                                <a href="product-details.html">
                                                    <img src="assets/shop/img/product/5/product-7.jpg" alt="">
                                                </a>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="tp-product-item-5 p-relative white-bg mb-40">
                                            <div class="tp-product-thumb-5 w-img fix mb-15">
                                                <a href="product-details.html">
                                                    <img src="assets/shop/img/product/5/product-8.jpg" alt="">
                                                </a>
        ...
        <section class="tp-deal-area pt-135 pb-140 p-relative z-index-1 fix scene" data-bg-color="#F3F3F3">
            <div class="tp-deal-shape">
                <img class="tp-deal-shape-7" src="assets/shop/img/deal/shape/shape-7.png" alt="">
            </div>
            <div class="tp-deal-shape">
                <div class="tp-deal-shape-1">
                    <img class="layer" data-depth=".2" src="assets/shop/img/deal/shape/shape-1.png" alt="">
                </div>
                <div class="tp-deal-shape-2">
                    <img class="layer" data-depth=".3" src="assets/shop/img/deal/shape/shape-2.png" alt="">
                </div>
                <div class="tp-deal-shape-3">
                    <img class="layer" data-depth=".4" src="assets/shop/img/deal/shape/shape-3.png" alt="">
                </div>
                <div class="tp-deal-shape-4">
                    <img class="layer" data-depth=".5" src="assets/shop/img/deal/shape/shape-4.png" alt="">
                </div>
                <div class="tp-deal-shape-5">
                    <img class="layer" data-depth=".6" src="assets/shop/img/deal/shape/shape-5.png" alt="">
                </div>
                <div class="tp-deal-shape-6">
                    <img class="layer" data-depth=".7" src="assets/shop/img/deal/shape/shape-6.png" alt="">
                </div>
            </div>
            <div class="container">
                        ...
                        <div class="tp-product-side-banner text-center mb-60" data-bg-color="#EEEBE4">
                            <div class="tp-product-side-banner-content">
                                <div class="tp-product-side-banner-subtitle">
                                    <img src="assets/shop/img/product/side/pre-title.png" alt="">
                                </div>
                                <h3 class="tp-product-side-banner-title"> Get Up to 26% Off Vegetables </h3>

                                <div class="tp-product-side-banner-btn">
                                    <a href="shop.html" class="tp-btn-green tp-btn-green-sm">
                                        Shop Now
                                ...
                                <div class="tp-product-side-banner-thumb">
                                    <img src="assets/shop/img/product/side/side-1.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="tp-product-sm-item-wrapper-5 is-translate-24">
                                <div class="tp-product-sm-item-5 d-flex align-items-center">
                                    <div class="tp-product-sm-thumb-5 fix">
                                        <a href="product-details.html">
                                            <img src="assets/shop/img/product/sm/5/product-sm-1.jpg" alt="">
                                        </a>
                                    </div>
                                ...
                                <div class="tp-product-sm-item-5 d-flex align-items-center">
                                    <div class="tp-product-sm-thumb-5 fix">
                                        <a href="product-details.html">
                                            <img src="assets/shop/img/product/sm/5/product-sm-2.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="tp-product-sm-content-5">
                                        <div class="tp-product-sm-tag-5">
                                ...
                                <div class="tp-product-sm-item-5 d-flex align-items-center">
                                    <div class="tp-product-sm-thumb-5 fix">
                                        <a href="product-details.html">
                                            <img src="assets/shop/img/product/sm/5/product-sm-3.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="tp-product-sm-content-5">
                                        <div class="tp-product-sm-tag-5">
                        ...
                        <div class="tp-product-sm-wrapper-5 mb-60">
                            ...
                            <div class="tp-product-sm-item-wrapper-5">
                                <div class="tp-product-sm-item-5 d-flex align-items-center">
                                    <div class="tp-product-sm-thumb-5 fix">
                                        <a href="product-details.html">
                                            <img src="assets/shop/img/product/sm/5/product-sm-4.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="tp-product-sm-content-5">
                                        <div class="tp-product-sm-tag-5">
                                ...
                                <div class="tp-product-sm-item-5 d-flex align-items-center">
                                    <div class="tp-product-sm-thumb-5 fix">
                                        <a href="product-details.html">
                                            <img src="assets/shop/img/product/sm/5/product-sm-5.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="tp-product-sm-content-5">
                                        <div class="tp-product-sm-tag-5">
                                ...
                                <div class="tp-product-sm-item-5 d-flex align-items-center">
                                    <div class="tp-product-sm-thumb-5 fix">
                                        <a href="product-details.html">
                                            <img src="assets/shop/img/product/sm/5/product-sm-6.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="tp-product-sm-content-5">
                                        <div class="tp-product-sm-tag-5">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="tp-testimonial-item-5 d-md-flex swiper-slide white-bg">
                                            <div class="tp-testimonial-avater-wrapper-5 p-relative">
                                                <div class="tp-avater-rounded mr-60">
                                                    <div class="tp-testimonial-avater-5 ">
                                                        <img src="assets/shop/img/users/user-11.jpg" alt="">
                                                    </div>
                                                </div>
                                                <span class="quote-icon">
                                                    <img src="assets/shop/img/testimonial/testimonial-quote-2.png" alt="">
                                                </span>
                                            </div>
                                            ...
                                            <div class="tp-testimonial-content-5">
                                                ...
                                                <div class="tp-testimonial-user-5-info">
                                                    <h3 class="tp-testimonial-user-5-title">Theodore Handle <span style="color: red;">3</span></h3>
                                        ...
                                        <div class="tp-testimonial-item-5 d-md-flex swiper-slide white-bg">
                                            ...
                                            <div class="tp-testimonial-content-5">
                                                ...
                                                <div class="tp-testimonial-user-5-info">
                                                    <h3 class="tp-testimonial-user-5-title">Theodore Handle <span style="color: red;">1</span></h3>
                                                    <span class="tp-testimonial-user-5-designation">UI/UX design</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tp-testimonial-item-5 d-md-flex swiper-slide white-bg">
                                            ...
                                            <div class="tp-testimonial-content-5">
                                                ...
                                                <div class="tp-testimonial-user-5-info">
                                                    <h3 class="tp-testimonial-user-5-title">Theodore Handle <span style="color: red;">2</span></h3>
                                                    <span class="tp-testimonial-user-5-designation">UI/UX design</span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="tp-best-banner-slider-active-5 swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="tp-best-banner-item-5 p-relative fix swiper-slide">
                                        <a href="shop.html">
                                            <div class="tp-best-banner-thumb-5 include-bg grey-bg" data-background="assets/shop/img/banner/5/best-banner-1.jpg"></div>
                                        </a>
                                    </div>
                                    <div class="tp-best-banner-item-5 p-relative fix swiper-slide">
                                        <a href="shop.html">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="tp-best-item-5 swiper-slide">
                                            <div class="tp-product-item-5 p-relative white-bg mb-40">
                                                <div class="tp-product-thumb-5 w-img fix mb-15">
                                                    <a href="product-details.html">
                                                        <img src="assets/shop/img/product/5/product-9.jpg" alt="">
                                                    </a>
                                                ...
                                                <div class="tp-product-content-5">
                                                    ...
                                                    <h3 class="tp-product-title-5">
                                                        <a href="product-details.html">Sweet and fresh Strawberry</a>
                                                    </h3>
                                                    <div class="tp-product-rating-5">
                                                        <span><i class="fa-solid fa-star"></i></span>
                                                        <span><i class="fa-solid fa-star"></i></span>
                                        ...
                                        <div class="tp-best-item-5 swiper-slide">
                                            <div class="tp-product-item-5 p-relative white-bg mb-40">
                                                <div class="tp-product-thumb-5 w-img fix mb-15">
                                                    <a href="product-details.html">
                                                        <img src="assets/shop/img/product/5/product-10.jpg" alt="">
                                                    </a>
                                                ...
                                                <div class="tp-product-content-5">
                                                    ...
                                                    <h3 class="tp-product-title-5">
                                                        <a href="product-details.html">White vegetable healthy</a>
                                                    </h3>
                                                    <div class="tp-product-rating-5">
                                                        <span><i class="fa-solid fa-star"></i></span>
                                                        <span><i class="fa-solid fa-star"></i></span>
                                        ...
                                        <div class="tp-best-item-5 swiper-slide">
                                            <div class="tp-product-item-5 p-relative white-bg mb-40">
                                                <div class="tp-product-thumb-5 w-img fix mb-15">
                                                    <a href="product-details.html">
                                                        <img src="assets/shop/img/product/5/product-11.jpg" alt="">
                                                    </a>
        ...
        <section class="tp-cta-area fix pt-50 p-relative z-index-1">
            <div class="tp-cta-inner p-relative pt-80 pb-55" data-bg-color="#678E61">
                <div class="tp-cta-shape">
                    <img class="tp-cta-shape-1" src="assets/shop/img/cta/shape/cta-shape-1.png" alt="">
                    <img class="tp-cta-shape-2" src="assets/shop/img/cta/shape/cta-shape-2.png" alt="">
                </div>
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="tp-cta-thumb">
                                ...
                                <img src="assets/shop/img/cta/cta-thumb-1.jpg" alt="">
                            </div>
                            ...
                            <nav>
                                <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                                    <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-1" aria-selected="true">
                                        <img src="assets/shop/img/product/details/5/nav/product-details-nav-1.jpg" alt="">
                                    </button>
                                    <button class="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2" type="button" role="tab" aria-controls="nav-2" aria-selected="false">
                                        <img src="assets/shop/img/product/details/5/nav/product-details-nav-2.jpg" alt="">
                                    </button>
                                    <button class="nav-link" id="nav-3-tab" data-bs-toggle="tab" data-bs-target="#nav-3" type="button" role="tab" aria-controls="nav-3" aria-selected="false">
                                        <img src="assets/shop/img/product/details/5/nav/product-details-nav-3.jpg" alt="">
                                    </button>
                                    <button class="nav-link" id="nav-4-tab" data-bs-toggle="tab" data-bs-target="#nav-4" type="button" role="tab" aria-controls="nav-4" aria-selected="false">
                                        <img src="assets/shop/img/product/details/4/nav/product-details-nav-4.jpg" alt="">
                                    </button>
                                </div>
                            </nav>
                            <div class="tab-content m-img" id="productDetailsNavContent">
                                <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab" tabindex="0">
                                    <div class="tp-product-details-nav-main-thumb">
                                        <img src="assets/shop/img/product/details/5/main/product-details-main-1.jpg" alt="">
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab" tabindex="0">
                                    <div class="tp-product-details-nav-main-thumb">
                                        <img src="assets/shop/img/product/details/5/main/product-details-main-2.jpg" alt="">
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="nav-3" role="tabpanel" aria-labelledby="nav-3-tab" tabindex="0">
                                    <div class="tp-product-details-nav-main-thumb">
                                        <img src="assets/shop/img/product/details/5/main/product-details-main-3.jpg" alt="">
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="nav-4" role="tabpanel" aria-labelledby="nav-4-tab" tabindex="0">
                                    <div class="tp-product-details-nav-main-thumb">
                                        <img src="assets/shop/img/product/details/5/main/product-details-main-4.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="tp-footer-contact">
                                        <div class="tp-footer-contact-item d-flex align-items-start">
                                            ...
                                            <div class="tp-footer-contact-content">
                                                <p><a href="https://html.weblearnbd.net/cdn-cgi/l/email-protection#84f7ecebe2fdc4e3e9e5ede8aae7ebe9"><span class="__cf_email__" data-cfemail="493a21262f30092e24282025672a2624">[email&#160;protected]</span></a></p>
                                            </div>
                                        </div>
                                        <div class="tp-footer-contact-item d-flex align-items-start">
                                            <div class="tp-footer-contact-icon">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="tp-footer-payment text-md-end">
                                    <p>
                                        <img src="assets/shop/img/footer/footer-pay-2.png" alt="">
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    <script src="assets/shop/js/vendor/jquery.js"></script>
    <script src="assets/shop/js/vendor/waypoints.js"></script>
    <script src="assets/shop/js/bootstrap-bundle.js"></script>
    <script src="assets/shop/js/meanmenu.js"></script>
    <script src="assets/shop/js/swiper-bundle.js"></script>
    <script src="assets/shop/js/slick.js"></script>
    <script src="assets/shop/js/range-slider.js"></script>
    <script src="assets/shop/js/magnific-popup.js"></script>
    <script src="assets/shop/js/nice-select.js"></script>
    <script src="assets/shop/js/purecounter.js"></script>
    <script src="assets/shop/js/parallax.js"></script>
    <script src="assets/shop/js/countdown.js"></script>
    <script src="assets/shop/js/wow.js"></script>
    <script src="assets/shop/js/isotope-pkgd.js"></script>
...
<!-- Mirrored from html.weblearnbd.net/shofy-prv/shofy/index-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Oct 2023 08:18:36 GMT -->
