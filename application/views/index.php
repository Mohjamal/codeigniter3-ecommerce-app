        ...
        <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="avatar-md flex-shrink-0">
                                    <span
                                        class="avatar-title bg-subtle-primary text-primary rounded fs-2">
                                ...
                                <div class="flex-grow-1 overflow-hidden ms-4">
                                    ...
                                    <p class="text-muted mb-0 text-truncate">
                                        <span
                                            class="badge bg-subtle-success text-success font-size-12 fw-normal me-1"><i class="mdi mdi-arrow-top-right"></i> 2.8%
                                            Increase</span>
                                        vs last month
                                    </p>
                                </div>
                                <div class="flex-shrink-0 align-self-start">
                                    <div class="dropdown">
                                        <a
                                            class="dropdown-toggle btn-icon border rounded-circle"
                                            href="#"
                                            data-bs-toggle="dropdown"
                                            aria-haspopup="true"
                                            aria-expanded="false">
                                            <i
                                                class="ri-more-2-fill text-muted font-size-16"></i>
                                        </a>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 overflow-hidden ms-4">
                                    ...
                                    <h3 class="fs-4 flex-grow-1 mb-3">
                                        63,234
                                        <span class="text-muted font-size-16">NOU</span>
                                    </h3>
                                    <p class="text-muted mb-0 text-truncate">
                                        <span
                                            class="badge bg-subtle-danger text-danger font-size-12 fw-normal me-1"><i class="mdi mdi-arrow-bottom-left"></i> 7.8%
                                            Loss</span>
                                        vs last month
                                    </p>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 overflow-hidden ms-4">
                                    ...
                                    <p class="text-muted mb-0 text-truncate">
                                        <span
                                            class="badge bg-subtle-success text-success font-size-12 fw-normal me-1"><i class="mdi mdi-arrow-top-right"></i> 4.6%
                                            Growth</span>
                                        vs last month
                                    </p>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 overflow-hidden ms-4">
                                    ...
                                    <p class="text-muted mb-0 text-truncate">
                                        <span
                                            class="badge bg-subtle-success text-success font-size-12 fw-normal me-1"><i class="mdi mdi-arrow-top-right"></i> 23%
                                            Increase</span>
                                        vs last month
                                    </p>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div
                            class="card-header border-0 align-items-center d-flex pb-1">
                            <h4 class="card-title mb-0 flex-grow-1">
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <p
                                        class="text-muted text-center w-75 mx-auto mt-4 mb-0">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive mt-3">
                                        <table
                                            class="table align-middle table-centered table-nowrap mb-0">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <a
                                                            ...
                                                            class="text-dark">Product Pending</a>
                                                    </td>
                                                    <td>17,351</td>
                                                    <td>2,123</td>
                                                    <td>
                                                        <span
                                                            class="badge bg-subtle-primary text-primary font-size-11 ms-1"><i class="mdi mdi-arrow-up"></i>
                                                            45.3%</span>
                                                    </td>
                                                </tr>
                                                <!-- end -->
                                                ...
                                                <tr>
                                                    <td>
                                                        <a
                                                            href="javascript:void(0);"
                                                            class="text-dark">Product Cancelled</a>
                                                    </td>
                                                    <td>67,356</td>
                                                    <td>3,652</td>
                                                    <td>
                                                        <span
                                                            class="badge bg-subtle-danger text-danger font-size-11 ms-1"><i class="mdi mdi-arrow-down"></i>
                                                            14.6%</span>
                                                    </td>
                                                </tr>
                                                <!-- end -->
                                                ...
                                                <tr>
                                                    <td>
                                                        <a
                                                            href="javascript:void(0);"
                                                            class="text-dark">Product Delivered</a>
                                                    </td>
                                                    <td>67,356</td>
                                                    <td>3,652</td>
                                                    <td>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    <a
                                                        class="text-muted dropdown-toggle font-size-20"
                                                        role="button"
                                                        data-bs-toggle="dropdown"
                                                        aria-haspopup="true">
                                ...
                                <table class="table align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript: void(0);" class="text-body">#MB2540</a>
                                            </td>
                                            <td>
                                                <img
                                                    src="assets/images/users/avatar-2.jpg"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript: void(0);" class="text-body">#MB2541</a>
                                            </td>
                                            <td>
                                                <img
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript: void(0);" class="text-body">#MB2542</a>
                                            </td>
                                            <td>
                                                <img
                                                    src="assets/images/users/avatar-4.jpg"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript: void(0);" class="text-body">#MB2543</a>
                                            </td>
                                            <td>
                                                <img
                                                    src="assets/images/users/avatar-5.jpg"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript: void(0);" class="text-body">#MB2544</a>
                                            </td>
                                            <td>
                                                <img
                                                    src="assets/images/users/avatar-6.jpg"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript: void(0);" class="text-body">#MB2545</a>
                                            </td>
                                            <td>
                                                <img
                                                    src="assets/images/users/avatar-7.jpg"
